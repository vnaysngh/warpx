...
export class WarpPair__burnResult {
  value0: BigInt;
  value1: BigInt;
...
export class WarpPair__getReservesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class WarpPair extends ethereum.SmartContract {
  static bind(address: Address): WarpPair {
    return new WarpPair("WarpPair", address);
  }
  ...
  burn(to: Address): WarpPair__burnResult {
    let result = super.call("burn", "burn(address):(uint256,uint256)", [
      ethereum.Value.fromAddress(to),
    ]);

    return new WarpPair__burnResult(result[0].toBigInt(), result[1].toBigInt());
  }

  try_burn(to: Address): ethereum.CallResult<WarpPair__burnResult> {
    ...
    return ethereum.CallResult.fromValue(
      new WarpPair__burnResult(value[0].toBigInt(), value[1].toBigInt()),
    );
  }
  ...
  getReserves(): WarpPair__getReservesResult {
    let result = super.call(
      "getReserves",
    ...
    return new WarpPair__getReservesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
    );
  ...
  try_getReserves(): ethereum.CallResult<WarpPair__getReservesResult> {
    let result = super.tryCall(
      "getReserves",
      "getReserves():(uint112,uint112,uint32)",
      [],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new WarpPair__getReservesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
      ),
