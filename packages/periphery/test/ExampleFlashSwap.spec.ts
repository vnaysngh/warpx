...
import ExampleFlashSwap from '../../../artifacts/packages/periphery/contracts/examples/ExampleFlashSwap.sol/ExampleFlashSwap.json'
...
describe('ExampleFlashSwap', () => {
  ...
  it('warpCall:0', async () => {
    ...
    // now, execute arbitrage via warpCall:
