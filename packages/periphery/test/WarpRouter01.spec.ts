...
enum RouterVersion {
  WarpRouter01 = 'WarpRouter01',
  WarpRouter02 = 'WarpRouter02'
}

describe('WarpRouter{01,02}', () => {
  for (const routerVersion of Object.keys(RouterVersion)) {
    ...
    beforeEach(async function() {
      ...
      router = {
        [RouterVersion.WarpRouter01]: fixture.router01,
        [RouterVersion.WarpRouter02]: fixture.router02
    ...
    describe(routerVersion, () => {
      ...
      describe('swapExactTokensForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.WarpRouter01]: 101876,
              [RouterVersion.WarpRouter02]: 101898
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
      ...
      describe('swapExactETHForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.WarpRouter01]: 138770,
              [RouterVersion.WarpRouter02]: 138770
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
