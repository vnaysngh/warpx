...
/**
 * Deploy MSI - MegaSpeed Inu
 * Total Supply: 1 billion (same as WARPX)
 * Decimals: 18
 */
...
const TOKENS: TokenConfig[] = [
  {
    ...
    symbol: "MSI",
    decimals: 18,
    initialSupply: ethers.parseUnits("1000000000", 18) // 1 billion
  }
];
...
async function main() {
  ...
  console.log("🐕  DEPLOY MEGASPEED INU (MSI)");
  console.log("=".repeat(60));
  ...
  console.log("");
  console.log("=".repeat(60));
  console.log("✅ MSI DEPLOYMENT SUMMARY");
  console.log("=".repeat(60));
  ...
  console.log("=".repeat(60));
  console.log("1. Add MSI token logo to apps/web/public/logos/msi.jpeg (already exists!)");
  console.log("");
  console.log("2. Optionally create a liquidity pool for MSI/ETH or MSI/WARPX");
  console.log("");
  console.log("3. Update token constants if needed in:");
  console.log("   apps/web/lib/trade/constants.ts");
  console.log("");
  console.log("=".repeat(60));
}
