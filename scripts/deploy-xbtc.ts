...
/**
 * Deploy XBTC - a Bitcoin clone token
...
const TOKENS: TokenConfig[] = [
  {
    ...
    symbol: "XBTC",
    decimals: 8, // Same as BTC
    initialSupply: ethers.parseUnits("21000000", 8) // 21 million BTC
  }
];
...
async function main() {
  ...
  console.log("₿  DEPLOY XBTC (Bitcoin Clone)");
  console.log("=".repeat(60));
  ...
  console.log("");
  console.log("=".repeat(60));
  console.log("✅ XBTC DEPLOYMENT SUMMARY");
  console.log("=".repeat(60));
  ...
  console.log("");
  console.log("=".repeat(60));
  console.log("₿ XBTC TOKEN DEPLOYED SUCCESSFULLY!");
  console.log("=".repeat(60));
  console.log(`Total Supply: 21,000,000 XBTC`);
  console.log(`Decimals: 8 (same as Bitcoin)`);
  console.log(`All ${ethers.formatUnits(TOKENS[0].initialSupply, 8)} XBTC minted to deployer`);
  console.log("");
  console.log("🎯 NEXT STEPS:");
  console.log("=".repeat(60));
  console.log("1. Add XBTC to TOKEN_CATALOG in apps/web/lib/trade/constants.ts:");
  console.log("");
  deployments.forEach((t) => {
    console.log(`   {`);
    ...
    console.log(`     address: "${t.address}",`);
    console.log(`     decimals: ${t.decimals},`);
    console.log(`     logo: "/logos/xbtc.png" // Add logo file if you have one`);
    console.log(`   }`);
  });
  console.log("");
  console.log("2. XBTC has been added to your token manifest automatically");
  console.log("3. After adding to constants.ts, the token will appear in your frontend");
  console.log("4. You can then create liquidity pools with XBTC");
  console.log("");
  console.log("Example: Create XBTC/ETH pool via /pools/create");
  console.log("=".repeat(60));
}
